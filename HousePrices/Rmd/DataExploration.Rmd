...
In special cases certain features do not make sense
(e.g. $PoolArea$ with $PoolQC = noPool$).
This can be extracted from the *data_description*.

```{r}
MasVnrArea # gibts nur wenn MasVnrType := "None"
BsmtFinSF1, BsmtFinSF2, BsmtUnfSF, TotalBsmtSF,
BsmtFullBath, BsmtHalfBath # gibts nur bei BmstFinType1/2 := "noBasement"
GarageCars, GarageArea, GarageYrBlt # gibts nur wenn GarageType := "noGarage"
PoolArea # gibts nur wenn PoolQC != "noPool"
MiscVal # gibts nur wenn MiscFeature != "none"
```
...
featAttr$missing <- mdpat[nrow(mdpat), -nrow(mdpat)]
