...
Because RDA takes especially long it will only get 3 repetitions.
Nevertheless, the following functions can take some minutes.
...
*QDA* is slightly better than *RDA* with more than 81% predicted accuracy.
